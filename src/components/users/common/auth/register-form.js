...
const RegisterForm = ({ setDefaultTab }) => {
  ...
  const validationSchema = Yup.object({
    ...
    address: Yup.string().required("Please enter your address").min(10, "Must be at least 10 characters"),
    resetPasswordCode: Yup.string().required("Please enter your reset password code"),
    ...
    <Form noValidate onSubmit={formik.handleSubmit}>
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control
          ...
          isInvalid={
            formik.touched.resetPasswordCode && formik.errors.resetPasswordCode
          }
          isValid={
            formik.touched.resetPasswordCode && !formik.errors.resetPasswordCode
          }
